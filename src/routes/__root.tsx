...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BRHero — O primeiro RPG idle brasileiro. Batalhas automáticas, evolução épica e chefões lendários. Entre com Google e jogue no navegador ou baixe no Google Play." },
      ...
      { name: "twitter:description", content: "BRHero — O primeiro RPG idle brasileiro. Batalhas automáticas, evolução épica e chefões lendários. Entre com Google e jogue no navegador ou baixe no Google Play." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c9bcbf7a-c83b-4c42-ae81-6de55c912713" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c9bcbf7a-c83b-4c42-ae81-6de55c912713" },
    ],
    links: [
      {
        rel: "stylesheet",
